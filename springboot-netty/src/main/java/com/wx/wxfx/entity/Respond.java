...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Message.internal_static_cmpark_message_Respond_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Message.internal_static_cmpark_message_Respond_fieldAccessorTable
   ...
   * @return The code.
   */
  @Override public RespondCode getCode() {
    @SuppressWarnings("deprecation")
    RespondCode result = RespondCode.valueOf(code_);
    return result == null ? RespondCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (code_ != RespondCode.CODE_NOT_USED.getNumber()) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.wx.wxfx.entity.Respond.newBuilder()
    private Builder() {
     ...
     * @return This builder for chaining.
     */
    public Builder setCode(RespondCode value) {
      if (value == null) {
        throw new NullPointerException();
      }
