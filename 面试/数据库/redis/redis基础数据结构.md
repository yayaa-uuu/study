...
|REDIS_ENCODING_EMBSTR|embstr的简单动态字符串|
...
|REDIS_STRING|REDIS_ENCODING_EMBTER|使用embstr编码的简单字符串实现的字符串对象|
|REDIS_STRING|REDIS_ENCODING_RAW|使用简单动态字符串实现的字符串对象|
|REDIS_LIST|REDIS_ENCODING_ZIPLIST|使用压缩列表实现的对象|
|REDIS_LIST|REDIS_ENCODING_LINKEDLIST|使用双端列表实现的对象|
